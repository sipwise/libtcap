...
DialoguePortion_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
	...
	td->check_constraints = asn_DEF_ExternalPDU.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
}

/*
 * This type is implemented using ExternalPDU,
 * so here we adjust the DEF accordingly.
 */
static void
DialoguePortion_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_ExternalPDU.free_struct;
	td->print_struct   = asn_DEF_ExternalPDU.print_struct;
	td->ber_decoder    = asn_DEF_ExternalPDU.ber_decoder;
	td->der_encoder    = asn_DEF_ExternalPDU.der_encoder;
	td->xer_decoder    = asn_DEF_ExternalPDU.xer_decoder;
	td->xer_encoder    = asn_DEF_ExternalPDU.xer_encoder;
	td->uper_decoder   = asn_DEF_ExternalPDU.uper_decoder;
	td->uper_encoder   = asn_DEF_ExternalPDU.uper_encoder;
	if(!td->per_constraints)
		td->per_constraints = asn_DEF_ExternalPDU.per_constraints;
	td->elements       = asn_DEF_ExternalPDU.elements;
	td->elements_count = asn_DEF_ExternalPDU.elements_count;
	td->specifics      = asn_DEF_ExternalPDU.specifics;
}
