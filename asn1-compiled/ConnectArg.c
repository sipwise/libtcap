...
static asn_TYPE_tag2member_t asn_MAP_ConnectArg_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* destinationRoutingAddress at 545 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* alertingPattern at 546 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* correlationID at 547 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* cutAndPaste at 548 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* forwardingCondition at 549 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* iSDNAccessRelatedInformation at 551 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* originalCalledPartyID at 552 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* routeList at 553 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* scfID at 555 */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* travellingClassMark at 556 */
    { (ASN_TAG_CLASS_CONTEXT | (11 << 2)), 10, 0, 0 }, /* carrier at 558 */
    { (ASN_TAG_CLASS_CONTEXT | (12 << 2)), 16, 0, 0 }, /* displayInformation at 565 */
    { (ASN_TAG_CLASS_CONTEXT | (13 << 2)), 17, 0, 0 }, /* forwardCallIndicators at 566 */
    { (ASN_TAG_CLASS_CONTEXT | (14 << 2)), 18, 0, 0 }, /* genericNumbers at 567 */
    { (ASN_TAG_CLASS_CONTEXT | (15 << 2)), 19, 0, 0 }, /* serviceInteractionIndicatorsTwo at 569 */
    { (ASN_TAG_CLASS_CONTEXT | (16 << 2)), 20, 0, 0 }, /* iNServiceCompatibilityResponse at 571 */
    { (ASN_TAG_CLASS_CONTEXT | (17 << 2)), 21, 0, 0 }, /* forwardGVNS at 572 */
    { (ASN_TAG_CLASS_CONTEXT | (18 << 2)), 22, 0, 0 }, /* backwardGVNS at 573 */
    { (ASN_TAG_CLASS_CONTEXT | (19 << 2)), 23, 0, 0 }, /* chargeNumber at 574 */
    { (ASN_TAG_CLASS_CONTEXT | (20 << 2)), 24, 0, 0 }, /* callSegmentID at 575 */
    { (ASN_TAG_CLASS_CONTEXT | (21 << 2)), 25, 0, 0 }, /* legToBeCreated at 576 */
    { (ASN_TAG_CLASS_CONTEXT | (22 << 2)), 26, 0, 0 }, /* sDSSinformation at 577 */
    { (ASN_TAG_CLASS_CONTEXT | (23 << 2)), 27, 0, 0 }, /* calledDirectoryNumber at 578 */
    { (ASN_TAG_CLASS_CONTEXT | (24 << 2)), 28, 0, 0 }, /* bearerCapability at 579 */
    { (ASN_TAG_CLASS_CONTEXT | (26 << 2)), 11, 0, 0 }, /* serviceInteractionIndicators at 560 */
    { (ASN_TAG_CLASS_CONTEXT | (27 << 2)), 12, 0, 0 }, /* callingPartyNumber at 561 */
    { (ASN_TAG_CLASS_CONTEXT | (28 << 2)), 13, 0, 0 }, /* callingPartysCategory at 562 */
    { (ASN_TAG_CLASS_CONTEXT | (29 << 2)), 14, 0, 0 }, /* redirectingPartyID at 563 */
    { (ASN_TAG_CLASS_CONTEXT | (30 << 2)), 15, 0, 0 }, /* redirectionInformation at 564 */
    { (ASN_TAG_CLASS_CONTEXT | (31 << 2)), 34, 0, 0 }, /* cug-Interlock at 586 */
    { (ASN_TAG_CLASS_CONTEXT | (32 << 2)), 35, 0, 0 }, /* cug-OutgoingAccess at 587 */
    { (ASN_TAG_CLASS_CONTEXT | (33 << 2)), 36, 0, 0 }, /* ipRelatedInformation at 588 */
    { (ASN_TAG_CLASS_CONTEXT | (60 << 2)), 29, 0, 0 }, /* calledPartySubaddress at 580 */
    { (ASN_TAG_CLASS_CONTEXT | (61 << 2)), 30, 0, 0 }, /* connectionIdentifier at 581 */
    { (ASN_TAG_CLASS_CONTEXT | (62 << 2)), 31, 0, 0 }, /* genericIdentifier at 582 */
    { (ASN_TAG_CLASS_CONTEXT | (63 << 2)), 32, 0, 0 }, /* qOSParameter at 583 */
    { (ASN_TAG_CLASS_CONTEXT | (64 << 2)), 33, 0, 0 } /* bISDNParameters at 584 */
};
